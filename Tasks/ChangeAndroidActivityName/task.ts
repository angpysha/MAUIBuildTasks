...
function getAttributes(content: string) : string | null
{
    var reg : RegExp = /\[\s?Activity.*\]/gm
...
function replaceString(attrString: string, replaceString: string) : string
 {
    var labelIndex = attrString?.indexOf("Label");
